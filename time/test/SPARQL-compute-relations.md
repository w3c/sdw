...
```
INSERT { 
    ?t1 :before ?t2 ; :disjoint ?t2 . 
    ?t2 :after ?t1 ; :disjoint ?t1 . 
}
WHERE 
{
	?t1 a :Instant ; 
...
```
INSERT { 
    ?i1 :before ?i2 ; :disjoint ?i2 . 
    ?i2 :after ?i1 ; :disjoint ?i1 . 
}
WHERE 
{
	?i1 a :Interval ; 
...
```
INSERT { 
    ?i1 :intervalAfter ?i2 ; :intervalDisjoint ?i2 . 
    ?i2 :intervalBefore ?i1 ; :intervalDisjoint ?i1 . 
}
WHERE 
{
	?i1 a :ProperInterval ; 
...
### 3.3 hasInside / intervalIn
```
INSERT { 
    ?i1 :hasInside ?i2 ; :notDisjoint ?i2 . 
    ?i2 :notDisjoint ?i1 . 
}
WHERE 
{
